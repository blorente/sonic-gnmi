...
The examples use the following open source gNMI CLI tools:
  ...
  - [gnmi_get](https://github.com/google/gnxi/tree/master/gnmi_get): This tool allows for retrieval of one or more paths
  - [gnmi_set](https://github.com/google/gnxi/tree/master/gnmi_set): This tool allows for update, replace and delete operations.
...
Returns list of supported openconfig models and versions as well as supported encodings.
